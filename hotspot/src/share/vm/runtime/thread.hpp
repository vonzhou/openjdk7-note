...
/**
 * A JavaThread instance that represents the java.lang.Thread instance inside the VM. 
 * It contains additional information to track the state of the thread. 
 A JavaThread holds a reference to its associated java.lang.Thread object (as an oop), 
 and the java.lang.Thread object also stores a reference to its JavaThread (as a raw int). 
...
class JavaThread: public Thread {
 ...
 private:
  ...
  oop            _threadObj;                     // The Java level thread object 引用java.lang.Thread对象
